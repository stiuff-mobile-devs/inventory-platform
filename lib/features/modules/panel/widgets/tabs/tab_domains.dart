...
class TabDomains extends StatefulWidget {
  const TabDomains({super.key});

  @override
  State<TabDomains> createState() => _TabDomainsState();
}

class _TabDomainsState extends State<TabDomains> {
  ...
  void initState() {
    ...
    _panelController.searchController.addListener(() {
      _filterDomains(_panelController.searchController.text);
    });
  }
      ...
      child: Column(
        ...
        children: [
          ...
          SearchBarWidget(
            ...
            onSearchTextChanged: _filterDomains,
  ...
  void _filterDomains(String query) {
    ...
    final filteredList = _panelController.domains
        .where((domain) =>
            domain.title.toLowerCase().contains(query.toLowerCase()))
        .toList();
      ...
      children: [
        ...
        TextButton.icon(
          onPressed: () {
            ...
            Get.toNamed(AppRoutes.form, arguments: [TabType.domains]);
          },
      ...
      child: Obx(() {
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            if (items[index] is DomainModel) {
              DomainModel item = items[index];
